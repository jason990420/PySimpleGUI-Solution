...
class GUI():
    ...
    def Tree(self, key):
        ...
        font=self.font2, num_rows=27, row_height=26, justification='left',
        expand_y=True, vertical_scroll_only=False, key=key)
    ...
    def Multiline(self, key):
        return sg.Multiline(default_text='', size=(self.line_width, 35),
            ...
            text_color='white', background_color='blue', expand_y=True, horizontal_scroll=True)
